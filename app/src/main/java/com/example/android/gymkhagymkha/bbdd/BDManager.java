...
public class BDManager {
	...
	public static final String CN_INITIAL_LATITUDE = "initial_latitude";
	public static final String CN_INITIAL_LONGITUDE = "initial_longitude";
	...
	public static final String CREATE_TABLE_TREASURE = "create table " + TABLE_TREASURE
			...
			+ " text," + CN_TREASURE_CLUE + " text," + CN_TREASURE_STATE + " text," + CN_TREASURE_LATITUDE + " double," + CN_TREASURE_LONGITUDE + " double," + CN_INITIAL_LATITUDE + " double," + CN_INITIAL_LONGITUDE + " double)";
	...
	public void guardarTesoro(Clase_Tesoro tesoro) {
		...
		valores.put(CN_INITIAL_LATITUDE, tesoro.getlatitudInicial());
		valores.put(CN_INITIAL_LONGITUDE, tesoro.getlongitudInicial());
	...
	public Cursor cursorTesoros() {
		...
		String[] columnas = new String[] { CN_ID, CN_IDTREASURE , CN_TREASURE_NAME, CN_TREASURE_CLUE, CN_TREASURE_STATE,CN_TREASURE_LATITUDE,CN_TREASURE_LONGITUDE, CN_INITIAL_LATITUDE, CN_INITIAL_LONGITUDE};
